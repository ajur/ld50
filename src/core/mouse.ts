...
// export class GlobalPointerSteering_old {
...
//     private _settings: SteeringSettings;
...
//         if (GlobalPointerSteering.instance) {
//             const movement = pane.addFolder({title: "Steering"});
//             movement.addInput(GlobalPointerSteering.instance, "steeringShowHelper", {
//                 label: "Show onscreen thumbstick"
//             });
//             movement.addInput(GlobalPointerSteering.instance, "steeringType", {
//                 view: "list",
//                 label: "Type",
//                 options: [
//                     {text: "Virtual thumbstic", value: "Thumbstick"},
...
//         this._settings = localLoadDefault(STORAGE_KEY, {
//             showHelper: true,
//             type: "Thumbstick"
//         });
...
//     private get steeringShowHelper(): boolean {
//         return this._settings._showHelper;
//     }

//     private set steeringShowHelper(val: boolean) {
//         this._settings._showHelper = val;
//         localSave(STORAGE_KEY, this._settings);
//     }

//     private get steeringType(): SteeringType {
//         return this._settings._type;
//     }

//     private set steeringType(val: SteeringType)  {
//         this._settings._type = val;
//         localSave(STORAGE_KEY, this._settings);
//     }
...
//         this.pointerStart.visible = this.steeringShowHelper;
//         this.paintTarget.addChild(this.pointerStart, this.pointerPos);
...
//         this.pointerPos.position.copyFrom(vpp);
//         this.pointerPos.visible = this.steeringShowHelper;
